...
OUTPUT_PATH = "/home/FM/results/Trade_In/Bookfinder_Sell"
...
class ExtractPipeline(object):
    def __init__(self):
        ...
        self.file_name = '{}/Bookfinder_Trade-In_Sell_Pricing_{}.csv'.format(OUTPUT_PATH, self.start_formatted_time)

        self.export_fields = ['title', 'isbn10','isbn13', 'vendor_sell', 'selling_price', 'url_sell']
    ...
    def spider_closed(self, spider):
        ...
        log.info('[+++++] Output file path: /home/FM/results/Trade_In/Bookfinder_Sell')
