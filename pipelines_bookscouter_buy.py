...
# OUTPUT_PATH = "/home/nigam_parikh_scp/FM/results/Bookscouter/Trade-In/Buy_Pricing"
...
class ExtractPipeline(object):
    def __init__(self):
        ...
        self.file_name = '{}/Bookscouter_Trade-In_Buy Pricing_{}.csv'.format(OUTPUT_PATH,time_local.strftime('%d%b%Y_%Hhr%Mmin'))

        self.export_fields = ['title', 'isbn10', 'isbn13', 'condition', 'vendor', 'purchase_cost',
                            'shipping_cost', 'processing_cost', 'net_buying_cost', 'url_buy']
    ...
    def spider_closed(self, spider):
        ...
        log.info('[+++++] Output file path: /home/nigam_parikh_scp/FM/results/Bookscouter/Trade-In/Buy_Pricing')
