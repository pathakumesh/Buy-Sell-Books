...
# OUTPUT_PATH = "/home/FM/results/Trade_In/Bookfinder_Buy/"
...
class ExtractPipeline(object):
    def __init__(self):
        ...
        self.file_name = '{}/Bookfinder_Trade-In_Buy_Pricing_{}.csv'.format(OUTPUT_PATH, self.start_formatted_time)

        self.export_fields = ['title', 'isbn10', 'isbn13', 'vendor_buy', 'description', 
                            'purchase_cost', 'processing_cost', 'net_buying_cost', 'url_buy']
    ...
    def spider_closed(self, spider):
        ...
        log.info('[+++++] Output file path: /home/FM/results/Trade_In/Bookfinder_Buy')
